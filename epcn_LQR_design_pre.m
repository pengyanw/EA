...
fileName = sprintf('matrix/A_B_grid%d_LalphaStable_%s.mat', ...
                   gridSize, mat2str(is_alpha_stable));

% ===== save vars =====
save(fileName, 'A', 'B_');

% ===== print information =====
fprintf('Saved A, B to: %s\n', fileName);
fprintf('Spectral radius of A: %.4f --> L-alpha-stable: %d\n', ...
        spectral_radius, is_alpha_stable);
