...
nTop        = 5;       % Number of top individuals (elites) to keep
...
cost_bm = alpha*costBM + (1-alpha)*nnz(K_bm)/max_links
...
saveas(figure(1), sprintf('figures/evo_bestcost_grid%d.png', gridSize));
saveas(figure(2), sprintf('figures/evo_avgcost_grid%d.png', gridSize));
saveas(figure(3), sprintf('figures/unstable_count_grid%d.png', gridSize));
